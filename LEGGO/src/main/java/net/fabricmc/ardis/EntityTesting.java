...
public class EntityTesting implements ModInitializer {
     ...
     */
    public static final EntityType<RainbowZombie> ZOMBIE = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier("ardis-the-legend", "zombie"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, RainbowZombie::new).dimensions(EntityDimensions.fixed(0.75f, 0.75f)).build()
    );
    @Override
    public void onInitialize() {
         ...
         */
        FabricDefaultAttributeRegistry.register(ZOMBIE, RainbowZombie.createMobAttributes());
    }
}
